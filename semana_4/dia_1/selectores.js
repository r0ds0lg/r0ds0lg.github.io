...
miEtiqueta.innnerHTML = "Me llamo" /*para hacerlo dinamico puedo aqui 
            asigna window.prompt para que el usuario me de el nombre. Esto acepta 
...
//La menta correcta de hacerlo es la siguiente (aunque la anterior funciona)

let nombreDinamico = document.querySelector("h2")
let nombre = window.prompt("Ingresa tu Nombre")
nombreDinamico.innerText = nombre

// let miCampo1 = docuemnt.querySelector('input[type="text"]')
// let miCampo2 = docuemnt.querySelector('input[type="password"]')
// let miCampo3 = docuemnt.querySelector('input[type="checkbox"]')
